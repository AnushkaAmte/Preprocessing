...
#preprocessing
#img read->grayscale(rgb has 3 channels,0/1 as 0-255, blur, canny edge detection, contour boxes)
...
imgtest = cv.imread(cv.samples.findFile(args.input))
src = cv.resize(imgtest, (500, 500))
if src is None:
